...
var colorSelect = [
    { 配色: '紅', 顏色: ['#e57c7c', '#cf1717', '#c71515'] },
    { 配色: '橙', 顏色: ['#f49d65', '#ef771f', '#de7f3a'] },
    { 配色: '黃', 顏色: ['#ffffc1', '#fec108', '#f1c207'] },
    { 配色: '地綠', 顏色: ['#cbcb75', '#808007', '#6f6f06'] },
    { 配色: '草綠', 顏色: ['#C4EBAA', '#9AF04C', '#88D443'] },
    { 配色: '淡藍', 顏色: ['#BDDFE9', '#7E9DC9', '#7E9DC9'] },
    { 配色: '紫', 顏色: ['#c2a2d1', '#9664ae', '#9664ae'] },
    { 配色: '灰', 顏色: ['#D3D3D3', '#A3A3A3', '#A3A3A3'] },
    { 配色: '粉', 顏色: ['#f7919d', '#E26170', '#E26170'] },
    { 配色: '深綠', 顏色: ['#A4C3B2', '#6B9080', '#6B9080'] },
    { 配色: '紅紫', 顏色: ['#E8C2CA', '#735D78', '#B392AC'] },
    { 配色: '咖啡', 顏色: ['#e19068', '#ad6846', '#ad6846'] },
        ...
        if (side_title.includes(side)) {
            ...
            if (type === '守護靈') {
                ...
                const locationXY_get = {
                    ...
                    10: { X: sideX + (picSize * (0.055 + (-font_move * 2))), Y: sideY + (picSize * (0.066 + level)) },
                    11: { X: sideX + (picSize * (-0.1 + (-font_move * 2))), Y: sideY + (picSize * (0.036 + level)) },
                    12: { X: sideX + (picSize * (-0.1)), Y: sideY + (picSize * (-0.088 + -level)) },
